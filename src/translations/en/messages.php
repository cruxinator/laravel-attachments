...
return [
    ...
    'console' => [
        ...
        'check_description' => 'Check config to verify best practices',
        'check_option_expert' => 'Exert Mode (Allows Inheritance and Multi Type).',
        'check_info_using_expert' => 'Running in expert mode (Be Careful)',
        'check_warn_inherit_and_sti' => 'Both a attachment_model and attachment_sub_models config are being set.',
        'check_warn_should_be_child' => 'Class %s used in config %s should be a child of from %s',
        'check_warn_should_inherit' => 'Class %s used in config %s should inherit from %s',
        'check_warn_missing_class' => 'Class %s defined in config but not found (did you dump the auto loader)',
        'check_warn_disk_not_found' => 'The Default Storage Disk Driver %s is not defined',
